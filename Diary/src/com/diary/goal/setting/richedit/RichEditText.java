...
/**
 * Custom widget that simplifies adding rich text editing capabilities to
 * Android activities. Serves as a drop-in replacement for EditText. Full
 * documentation can be found on project Web site
 * (http://github.com/commonsguy/cwac-richedit). Concepts in this editor were
 * inspired by: http://code.google.com/p/droid-writer
 * 
 */
public class RichEditText extends EditText implements EditorActionModeListener {
	...
	/*
	 * EFFECTS is a roster of all defined effects, for simpler iteration over
	...
	/*
	 * Standard one-parameter widget constructor, simply chaining to superclass.
	 */
	...
	/*
	 * Standard two-parameter widget constructor, simply chaining to superclass.
	 */
	...
	/*
	 * Standard three-parameter widget constructor, simply chaining to
	 * superclass.
	 */
	...
	/*
	 * If there is a registered OnSelectionChangedListener, checks to see if
	 * there are any effects applied to the current selection, and supplies that
	 * information to the registrant.
	 * 
	 * Uses isSelectionChanging to avoid updating anything while this callback
	 * is in progress (e.g., registrant updates a ToggleButton, causing its
	 * OnCheckedChangeListener to fire, causing it to try to update the
	 * RichEditText as if the user had clicked upon it.
	 * 
	...
	/*
	 * Call this to provide a listener object to be notified when the selection
	 * changes and what the applied effects are for the current selection.
	 * Designed to be used by a hosting activity to adjust states of toolbar
	 * widgets (e.g., check/uncheck a ToggleButton).
	 */
	...
	/*
	 * Call this to enable or disable handling of keyboard shortcuts (e.g.,
	 * Ctrl-B for bold). Enabled by default.
	 */
	...
	/*
	 * Call this to have an effect applied to the current selection. You get the
	 * Effect object via the static data members (e.g., RichEditText.BOLD). The
	 * value for most effects is a Boolean, indicating whether to add or remove
	 * the effect.
	 */
	...
	/*
	 * Returns true if a given effect is applied somewhere in the current
	 * selection. This includes the effect being applied in a subset of the
	 * current selection.
	 */
	...
	/*
	 * Returns the value of the effect applied to the current selection. For
	 * Effect<Boolean> (e.g., RichEditText.BOLD), returns the same value as
	 * hasEffect(). Otherwise, returns the highest possible value, if multiple
	 * occurrences of this effect are applied to the current selection. Returns
	...
	/*
	 * If the effect is presently applied to the current selection, removes it;
	 * if the effect is not presently applied to the current selection, adds it.
	 */
	...
	public interface OnSelectionChangedListener {
		 ...
		 * character positions, and a roster of all effects presently applied
		 * (so you can bulk-update a toolbar when the selection changes).
		 */
