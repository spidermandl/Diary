...
/*    private CellLayout.CellInfo mVacantCache = null;*/
    ...
    public FlipView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Flipview, defStyle, 0);
        mDefaultScreen = a.getInt(R.styleable.Flipview_defaultScreen, 1);
        a.recycle();
...
/*        if (!(child instanceof CellLayout)) {
   ...
   /*     if (!(child instanceof CellLayout)) {
    ...
    public boolean requestChildRectangleOnScreen(View child, Rect rectangle, boolean immediate) {
    	Log.e("requestChildRectangleOnScreen", "requestChildRectangleOnScreen");
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (fastDraw) {
            ...
            Log.e("mNextScreen", ""+mNextScreen);
            Log.e("mCurrentScreen", ""+mCurrentScreen);
