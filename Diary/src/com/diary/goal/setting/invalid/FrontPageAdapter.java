...
//			R.drawable.front_page_bg2, R.drawable.front_page_bg3,
//			R.drawable.front_page_bg4 };
//	private static final int[] layouts = { R.layout.front_page_1,
//			R.layout.front_page_2, R.layout.front_page_3, R.layout.front_page_4 };
//
...
//		view.setBackgroundDrawable(new BitmapDrawable(BitmapCustomize
//				.customizePicture(mContext, ids[index], DiaryApplication
//						.getInstance().getScreen_w(), DiaryApplication
//						.getInstance().getScreen_h(), false)));
