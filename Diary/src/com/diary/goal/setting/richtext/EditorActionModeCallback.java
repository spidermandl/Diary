...
public class EditorActionModeCallback {
	...
	protected RichTextEditView editor = null;
	protected Selection selection = null;
	protected EditorActionModeListener listener = null;
	protected HashMap<Integer, EditorActionModeCallback> chains = new HashMap<Integer, EditorActionModeCallback>();

	EditorActionModeCallback(int menuResource, RichTextEditView editor,
	...
	public static class Native extends EditorActionModeCallback implements
		...
		public Native(Activity host, int menuResource, RichTextEditView editor,
				EditorActionModeListener listener) {
	...
	public static class ABS extends EditorActionModeCallback implements
		...
		public ABS(Activity host, int menuResource, RichTextEditView editor,
				EditorActionModeListener listener) {
			super(menuResource, editor, listener);
			this.host = host;
		}
		...
		public boolean onCreateActionMode(
			...
			com.actionbarsherlock.view.MenuInflater inflater = mode
					.getMenuInflater();
		...
		public boolean onActionItemClicked(
			...
			if (next != null) {
				...
				Method method;
				try {
					method = host.getClass().getMethod(
									"startActionMode",com.actionbarsherlock.view.ActionMode.Callback.class);
