...
package com.diary.goal.setting.view.wheel;

import java.util.LinkedList;
import java.util.List;

import com.diary.goal.setting.R;
import com.diary.goal.setting.view.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// Shadows drawables
	protected GradientDrawable topShadow;
	protected GradientDrawable bottomShadow;
	...
	/**
	 * Gets resource id of the wheel background
	...
	/**
	 * Sets the resource id of the wheel background
	 * @param resource
	 */
	public void setBackground(int resource){
		backgroudResource=resource;
	}
	/**
	 * Gets view adapter
	...
	private void initResourcesIfNecessary() {
		...
		if(backgroudResource!=0)
			setBackgroundResource(backgroudResource);
	}
