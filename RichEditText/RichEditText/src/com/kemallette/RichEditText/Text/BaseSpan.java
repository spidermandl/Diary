...
public abstract class BaseSpan implements ISpan {
	...
	public BaseSpan(final int startPosition, final int endPosition,
	...
	public static void setSpan(final Object span, final Editable e,
			int startPosition, int endPosition, int flag) {
