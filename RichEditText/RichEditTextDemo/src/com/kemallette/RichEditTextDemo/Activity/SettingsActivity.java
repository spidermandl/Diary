...
public class SettingsActivity extends SherlockPreferenceActivity {
	...
	private static void bindPreferenceSummaryToValue(Preference preference) {
		...
		preference
				.setOnPreferenceChangeListener(SettingsActivity.sBindPreferenceSummaryToValueListener);

		// Trigger the listener immediately with the preference's current value.
		String newValue = PreferenceManager.getDefaultSharedPreferences(
				preference.getContext()).getString(preference.getKey(), "");
		SettingsActivity.sBindPreferenceSummaryToValueListener
	...
	public boolean onIsMultiPane() {
		...
		return SettingsActivity.isXLargeTablet(this)
				&& !SettingsActivity.isSimplePreferences(this);
	}
	...
	private void setupSimplePreferencesScreen() {
		...
		SettingsActivity
				.bindPreferenceSummaryToValue(findPreference(SettingsActivity.PREF_KEY_FULL_NAME));
		SettingsActivity
				.bindPreferenceSummaryToValue(findPreference(SettingsActivity.PREF_KEY_ADDRESS));
		SettingsActivity
				.bindPreferenceSummaryToValue(findPreference(SettingsActivity.PREF_KEY_PHONE_NUMBER));
		SettingsActivity
				.bindPreferenceSummaryToValue(findPreference(SettingsActivity.PREF_KEY_EMAIL));
	}
