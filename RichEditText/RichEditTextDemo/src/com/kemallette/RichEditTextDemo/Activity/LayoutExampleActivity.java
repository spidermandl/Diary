...
public class LayoutExampleActivity extends SherlockActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		flContainer.addView(LayoutInflater.from(this).inflate(
				getIntent().getIntExtra(EXTRA_LAYOUT_RES, 0), flContainer,
				false));
		tvExplanation.setText(getIntent().getIntExtra(
				EXTRA_LAYOUT_EXPL_STR_RES, 0));
		tvTitle.setText(getIntent().getStringExtra(EXTRA_TITLE));
	}

	public static Intent buildIntent(Context ctx, String title, int layoutRes,
