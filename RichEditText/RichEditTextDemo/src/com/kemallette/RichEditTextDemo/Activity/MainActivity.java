...
public class MainActivity extends SherlockListActivity implements
	...
	private ListItem[] lItems = new ListItem[] {
			...
			new SimpleListItem("RichEditText", EditingExampleActivity.class),
			new SimpleListItem("Custom Fonts", ValidationsExampleActivity.class),
			new SimpleListItem("Validations", ValidationsExampleActivity.class),
			new SimpleListItem("DiaryEdit", DiaryEditActivity.class)};
